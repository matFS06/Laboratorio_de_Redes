...
•	Acesso ao servidor web onde o código HTML da página web da empresa Help Soluções em TI está disponível.
•	Uma conta no Laboratório Elan e acesso remoto.
•	O Docker instalado em sua máquina local ou no servidor remoto.
